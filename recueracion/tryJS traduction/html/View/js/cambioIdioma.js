...
//-------------------------------------------------------*/
    ...
    function traducirIU2(idioma='') {
      ...
      //import { getSpanish } from './strings_SPANISH.js';
      //import { getEnglish } from './strings_ENGLISH.js';
      //import { arrayGALLAECIAN } from './strings_GALLAECIAN.js';
      //const arrayGALLAECIAN = arrayGALLAECIAN();
      //require ("../../Locale/Strings_GALLAECIAN.js");
      //
