...
function comprobarFechaNacimiento(campo) {
    ...
    document.getElementById("truco").innerHTML= 1+1;
    document.write("debugg");
    document.write(campo);
    document.write(actualDate.getFullYear());

    document.write(actualDate.getMonth());
    document.write(actualDate.getDate());
