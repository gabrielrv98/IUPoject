...
// la función get_data_form() recoge los valores que vienen del formulario por medio de post y la action a realizar, crea una instancia USUARIOS y la devuelve
	function get_data_form(){
		...
		$_REQUEST['apellidos'],$_REQUEST['email'],$_REQUEST['DNI'],$_REQUEST['tlf'],$_REQUEST['fechaNacimiento'],$_REQUEST['alergias'],$_REQUEST['direccion'],$_REQUEST['cp'],$_REQUEST['sexo'],$_REQUEST['tipo_usuario']);// se Crea el nuevo usuario
