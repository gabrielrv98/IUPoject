...
include_once '../View/noPermiso.php';
 ...
 session_start();
	...
	include_once '../View/PRODUCTOS_CATEGORIAS_SHOWCURRENT_View.php';
	include_once '../View/PRODUCTOS_CATEGORIAS_SHOWALL_View.php';   
	include_once '../View/PRODUCTOS_CATEGORIAS_SEARCH_View.php';   
	include_once '../View/PRODUCTOS_CATEGORIAS_DELETE_View.php';	 
	include_once '../View/PRODUCTOS_CATEGORIAS_EDIT_View.php';   
	include_once '../View/PRODUCTOS_CATEGORIAS_ADD_View.php';   
