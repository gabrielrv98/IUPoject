...
const arrayENGLISH =  {     
      ...
      'Volver' : 'Back',
      'unidades' : 'unities',
      'deleteUserInfo' : 'An user with products cannot be deleted',
    ...
    'timeHelp':'Press the button on the right of the input to set the hour',
    'addMSG' : 'Add message',
