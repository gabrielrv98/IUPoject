		 ...
		 ?>
			...
			<form name = 'Form' action='../Controller/PRODUCTOS_Controller.php?action=DELETE' method='post' onsubmit="return comprobarProductos(this);" enctype="multipart/form-data">
				...
				<div class="form-group">
				 	...
				 	<br> 
				 	<textarea class="form-control" type = 'text' name = 'descripcion' id = 'descripcion' cols='100' rows='5' placeholder = 'letras y numeros' size = '50' onblur="comprobarAlfabeticoEnter(this,200)"  rows="5" readonly ><?php echo $this->valores['DESCRIPCION'];?>  </textarea> 
