...
//-------------------------------------------------------
	...
	class PRODUCTOS_ADD{
		...
		<?php include '../View/Header.php'; //header necesita los strings ?>
			...
			<form name = 'Form' action='../Controller/PRODUCTOS_Controller.php?action=ADD' method='post' onsubmit="return comprobarProductosADD(this);" enctype="multipart/form-data">
				...
				<div class="form-group">
				 	<label for="vendedorDNI" class="persona" onchange="comrpobarDni(this)"> persona   </label>
