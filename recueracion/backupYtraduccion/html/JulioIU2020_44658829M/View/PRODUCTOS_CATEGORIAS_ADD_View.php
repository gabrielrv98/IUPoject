		...
		<?php include '../View/Header.php'; //header necesita los strings ?>
			...
			<form name = 'Form' action='../Controller/PRODUCTOS_CATEGORIAS_Controller.php?action=ADD' method='post' onsubmit="return comprobarProductosCategoria(this);" enctype="multipart/form-data">
				...
				<div class="form-group">
				 	...
				 	<select name="idCategoria" id="idCategoria" onchange="comprobarEntero(this);" required>
				...
				<div class="form-group">
				 	...
				 	<select name="idProducto" id="idProducto" onchange="comprobarEntero(this);" required>
				 		<?php foreach ($this->datosProductos as $key) { ?>
				 			<option value="<?php echo $key['ID'];?>"> <?php echo $key['TITULO']; ?></option>
				 		<?php }  ?>
					</select>

				 	<label class="errormsg idProductoError" for="idProducto" id="idProducto_error" >Error en el producto </label>
				</div>&nbsp;&nbsp;
