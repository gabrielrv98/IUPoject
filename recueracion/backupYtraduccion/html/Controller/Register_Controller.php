...
if(!isset($_POST['login'])){// si la variable login no existe se muestra la interfaz de registro
	...
	$usuario = new USUARIOS_Model($_REQUEST['login'],$_REQUEST['password'],$_REQUEST['nombre'],
		$_REQUEST['apellidos'],$_REQUEST['email'],$_REQUEST['DNI'],$_REQUEST['tlf'],$_REQUEST['fechaNacimiento'],$_REQUEST['alergias'],$_REQUEST['direccion'],$_REQUEST['cp'],$_REQUEST['sexo'],'usuario','activado');// se Crea el nuevo usuario
