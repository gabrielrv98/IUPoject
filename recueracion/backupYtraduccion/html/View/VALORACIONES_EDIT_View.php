...
//-------------------------------------------------------
	...
	class VALORACIONES_EDIT{
		...
		<?php include '../View/Header.php'; //header necesita los strings ?>
			...
			<form name = 'Form' action='../Controller/VALORACIONES_Controller.php?action=EDIT' method='post' onsubmit="return comprobarValoracion(this);" enctype="multipart/form-data">
				...
				<div class="form-group">
					<label for="coment" class="coment"> </label> 
				 	<br> 
				 	<textarea name="coment" id="coment" cols='80' rows='3' onblur="comprobarAlfabeticoEnter(this,200);" ><?php echo $this->valores['COMENTARIO']; ?></textarea> 
				...
				<div class="form-group">
					<label for="punt" class="puntuacion"> </label> 
				 	<br> 
				 	<input type="number" name="punt" id="punt" onchange="comprobarPuntuacion(this);" value="<?php echo $this->valores['PUNTUACION'] ?>" >
