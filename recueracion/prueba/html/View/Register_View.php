		...
		<?php include '../View/Header.php'; //header necesita los strings ?>
			...
			<form name = 'Form' action='../Controller/Register_Controller.php' method='post' onsubmit="return comprobarUsuarios(this);">
				...
				<div class="form-group">
				 	...
				 	<input class="form-control" type = 'text' name = 'fechaNacimiento' id = 'fechaNacimiento' onblur="comprobarFechaNacimiento(this);" value="" placeholder="<?php echo $strings["format"]; ?>" onkeydown=" return false" required>
