...
//-------------------------------------------------------
	class ESPACIO_SEARCH{
		...
		?>
			...
			<h1 class="searchEspacio"><?php echo $strings['searchEspacio']; ?></h1>	
			<form name = 'Form' action='../Controller/ESPACIO_Controller.php?action=SEARCH' method='post' onsubmit="return comprobarEspacioSearch(this);">
				...
				<div class="form-group">
				 	...
				 	<label class="errormsg numberError" for="superficie" id="superficie_error" > <?php echo $strings['numberError'] ?> </label>
				</div>&nbsp;&nbsp;
				...
				<div class="form-group">
				 	...
				 	<label class="errormsg numberError" for="nInventario" id="nInventario_error" > <?php echo $strings['numberError'] ?> </label>
				</div>&nbsp;&nbsp;
